...
# # McKinney Chapter 4 - Practice (Section 04, Wednesday 11:45 AM)
...
get_ipython().run_line_magic('timeit', 'np.array([i**2 for i in range(100_001) if i%2==0])')


# In[12]:


get_ipython().run_line_magic('timeit', 'np.array([i**2 for i in range(0, 100_001, 2)])')
